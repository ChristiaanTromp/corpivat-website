...
export default function Wachtlijst() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Voor nu simuleren we een succesvolle submission
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      setIsSubmitted(true);
      console.log('Wachtlijst aanmelding:', formData);
    } catch (error) {
            ...
            <div className="section-padding">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl sm:text-2xl text-white mb-8 leading-relaxed">
                  We nemen contact met uw op zodra wij starten met de pilot.
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200 text-center">
                    <div className="mb-6">
                      ...
                      <p className="text-gray-600 mb-6">
                        Bedankt voor je interesse in CoPrivat. We nemen contact met uw op zodra we starten met de pilot.
                      </p>
                    </div>
