  ...
  const steps = [
    {
      ...
      description: "Alle digitale post wordt automatisch ontvangen en gescand",
      icon: (
    ...
    {
      number: 3,
      title: "Patiënt matching",
      description: "Het systeem koppelt het document aan het juiste patiëntendossier",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Documenten worden automatisch toegevoegd aan het EPD-systeem",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
